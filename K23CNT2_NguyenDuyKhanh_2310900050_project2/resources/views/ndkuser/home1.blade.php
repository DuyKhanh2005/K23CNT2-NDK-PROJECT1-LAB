            ...
            @foreach ($sanPhams as $sanPham)
                ...
                <div class="col-md-4 mb-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">{{ $sanPham->ndkTenSanPham }}</h5>
                            <p class="card-text"><strong>{{ number_format($sanPham->ndkDonGia, 0, ',', '.') }} VND</strong></p>
                            <p class="card-text"><small class="text-muted">Số lượng còn lại: {{ $sanPham->ndkSoLuong }}</small></p>
                            
                            <!-- Nút xem chi tiết -->
                            <a href="{{ route('ndkuser.show', $sanPham->id) }}" class="btn btn-primary btn-sm flex " style="justify-content: center">Xem Chi Tiết</a>
                          ...
                          <!-- Nút Mua và icon giỏ hàng -->
                            ...
                            <!-- Thêm vào giỏ hàng -->
                        <button type="button" class="btn btn-warning btn-sm add-to-cart-btn" data-id="{{ $sanPham->id }}" data-name="{{ $sanPham->ndkTenSanPham }}">
