            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                @foreach($products as $sanpham)
                    <div class="bg-white shadow-lg rounded-lg overflow-hidden transform transition-all hover:scale-105 hover:shadow-xl">
                        ...
                        <div class="p-4">
                            <h5 class="text-lg font-semibold text-gray-800">{{ $sanpham->ndkTenSanPham }}</h5>
                            <p class="text-red-500 font-bold mt-2">{{ number_format($sanpham->ndkDonGia, 0, ',', '.') }} VND</p>
                            ...
                            <div class="mt-4">
                                ...
                                <div class="flex gap-4">
                                    ...
                                    <a href="javascript:void(0);"   
                                       ...
                                       onclick="return confirm('Bạn muốn mua {{ $sanpham->ndkTenSanPham }} này không ?');" 
                                       title="Mua">
