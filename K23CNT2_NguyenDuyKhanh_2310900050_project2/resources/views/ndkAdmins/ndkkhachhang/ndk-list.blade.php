    ...
    <div class="container border mt-4">
        <div class="row mb-4">
            <div class="col-12 d-flex justify-content-between align-items-center">
                ...
                <!-- Nút Thêm Mới -->
                <a href="/ndk-admins/ndk-khach-hang/ndk-create" class="btn btn-success btn-lg">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <div class="btn-group" role="group">
                                    <!-- Xem chi tiết -->
                                    <a href="/ndk-admins/ndk-khach-hang/ndk-detail/{{ $item->id }}" class="btn btn-success btn-sm" title="Xem">
                                        <i class="fa-solid fa-eye"></i>
                                    </a>
                                    <!-- Chỉnh sửa -->
                                    <a href="/ndk-admins/ndk-khach-hang/ndk-edit/{{ $item->id }}" class="btn btn-primary btn-sm" title="Chỉnh sửa">
                                        <i class="fa-solid fa-pen"></i>
                                    </a>
                                    <!-- Xóa -->
                                    <a href="/ndk-admins/ndk-khach-hang/ndk-delete/{{ $item->id }}" class="btn btn-danger btn-sm" 
