...
<header class="bg-dark text-white p-3">
    <div class="container d-flex justify-content-between align-items-center">
        ...
        <div class="logo">
            <a href="/ndk-admins" class="text-white text-decoration-none">
        ...
        <nav class="navbar navbar-expand-md navbar-dark">
            <ul class="navbar-nav me-auto mb-2 mb-md-0">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/ndk-admins/ndkdanhsachquantri/ndksanpham" style="font-size: 14px;">Sản phẩm</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/admin/orders" style="font-size: 14px;">Đơn hàng</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/ndk-admins/ndkdanhsachquantri/ndknguoidung" style="font-size: 14px;">Người dùng</a>
                </li>
            </ul>
        </nav>
        ...
        <div class="d-flex align-items-center">
            ...
            <a href="{{route('admins.ndkLogin')}}" class="text-white text-decoration-none" style="font-size: 14px;">Đăng xuất</a> <!-- Link đăng xuất -->
        </div>
    </div>
</header>
