    ...
    <div class="container d-flex justify-content-between align-items-center">
        ...
        <div class="logo">
            <a href="/ndk-admins" class="text-white text-decoration-none">
                ...
                <img src="{{ asset('storage/img/san_pham/Logo-S.jpg') }}" alt="Logo" class="img-fluid" />
            </a>
        </div>

        <!-- Menu Navigation -->
        <!-- Search form -->
        <form action="{{ route('ndkuser.searchAdmins') }}" method="GET" class="search-form">
        ...
        <div class="d-flex align-items-center">
            ...
            <a href="{{route('admins.ndkLogin')}}" class="text-white text-decoration-none" style="font-size: 14px;">Đăng xuất</a>
        </div>
    </div>
</header>
