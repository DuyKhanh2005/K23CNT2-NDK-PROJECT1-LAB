  ...
  <div class="header bg-gradient-to-r from-gold-500 to-purple-600">
    <div class="container mx-auto">
      ...
      <div class="flex justify-between items-center py-2 text-sm">
        <div>
          <a class="mr-4 hover:underline text-gold-300" href="{{route('ndkuser.home')}}">Trang Chủ</a>
        ...
        <div>
          ...
          <a class="mr-4 hover:underline text-gold-300" href="ndk-user/support">
          ...
          <a class="mr-4 hover:underline text-gold-300" href="ndk-user/signup">Đăng Ký</a>
          <a class="hover:underline text-gold-300" href="{{route('ndkuser.login')}}">Đăng Nhập</a>
        </div>
      </div>
      <!-- Main Navigation -->
      <div class="flex items-center py-4">
        <div class="flex items-center">
          <a href="{{route('ndkuser.home1')}}">
            <img alt="logo" class="mr-2 rounded-full" height="120" src="/storage/img/san_pham/Logo.png" width="120"/>
          </a>
          <span class="text-3xl font-bold text-gold-500 animate-pulse">NDK SMART</span>
        </div>
        <div class="flex-grow mx-4">
          <form action="{{route('ndkuser.search')}}" method="GET" class="flex">
