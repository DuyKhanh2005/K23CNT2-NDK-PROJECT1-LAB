    ...
    <div class="container mx-auto">
      ...
      <div class="flex justify-between items-center py-2 text-sm">
        <div>
          ...
          <a class="mr-4 hover:underline" href="{{route('ndkuser.home')}}">Trang Chủ</a>
        ...
        <div>
          ...
          <a class="mr-4 hover:underline" href="ndk-user/support">
          ...
          <a class="hover:underline" href="{{route('ndkuser.login')}}">Đăng Nhập</a>
        </div>
      </div>
      <!-- Main Navigation -->
      <div class="flex items-center py-4">
        <div class="flex items-center">
          <a href="{{route('ndkuser.home')}}"><img alt=" logo" class="mr-2" height="40" src="/storage/img/san_pham/logoD.jpg" width="40"/></a>
